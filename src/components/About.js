      ...
      <Row className="justify-content-center">
        <Col xs={8}>
          <div className="about">
            ...
            <p>
              This page introduces the Decentralized Factoring Challenge (DFC),
              a first step towards providing a mechanism for creating
              mathematical prizes. The DFC provides a mechanism for anyone to
              contribute to prizes for factoring large integers and, by
              leveraging Ethereum smart contracts, provides a guarantee that the
              first party to find the factors will be able to claim the prize.
              This page reviews the significance and future expectations for
              integer factorization, as well as the mechanics of the DFC.
            </p>
            ...
            <p>
              ...
              in 2007, researchers have continued to pursue the challenges. For
              example, Boudot et al. factored RSA-250 in 2020, the largest RSA
              number to be factored so far.
            </p>
            <p>
              Although the RSA Factoring Challenge successfully demonstrated the
              security of public-key cryptography against current technology,
              the emergence of quantum computation has raised the possibility
              that public-key cryptography based on factorization will be broken
              in coming decades. In 1994, Peter Shor introduced a quantum
              algorithm that is almost exponentially faster than the best known
              classical algorithms for integer factorization. Although no
              quantum computers existed at that time, recent years have seen
              significant breakthroughs in the realization of quantum computers.
              For example, in 2019, Google announced that their quantum
              processor had achieved quantum supremacy, a major milestone in the
            ...
            <p>
              ...
              available by approximately 2033. Similarly, as of March 2022, the
              Metaculus prediction community has{" "}
            ...
            <p>
              ...
              providing a smart contract offering a prize for the factorization
              of large integers. Unlike many other mathematical contests, the
              DFC allows anyone to donate to the prize pool. Importantly, the
              mechanics of contract allow donors to have confidence that the
              first person to factor the integer will be able to withdraw the
              prize.
            </p>
            <p>
              There are three ways to interact with a DFC contract: donating to
              the prize, submitting a sealed claim, and withdrawing the prize.
            ...
            <p>
              This <tt>withdraw</tt> method performs several checks. First, the
              submitted factors must multiply to the target product. Second, the
              hash of the submitted factors must match a previously submitted
              sealed claim from the same Ethereum address. Third, the number of
              blocks mined since the sealed claim was submitted must equal or
              exceed the withdrawl delay. (This withdrawl delay, along with the
              product to be factored, are the two parameters defining a DFC
              contract.) The second and third checks allow for claimants to
              prevent front-running, i.e. a malicious miner using the claimant's
              factors to withdraw the prize to their own address.
            </p>
          </div>
        </Col>
      </Row>
