        ...
        <Col xs={8}>
          <div className="about">
            ...
            <p>
              ...
              www.sesamefoundation.org, including any content, functionality and
              services offered on or via sesamefoundation.org (the "Website").{" "}
            </p>
            <p>
              We want to keep our relationship with you as lean and informal as
              possible, but please read the Terms of Service carefully before
              you start using the Sesame Foundation, because by using the
              Website you accept and agree to be bound and abide by these Terms
              of Service.
            </p>
            <h2> 2. Changes to the Terms of Service and the Website</h2>
            <p>
              The Sesame Foundation is a work in progress, meaning that a lot
              will change in the near future. We reserve the right to update the
              Website and these Terms of Service from time to time, at our
            ...
            <p>
              ...
              Ethereum wallet to interact with the Ethereum blockchain. You must
              ensure that any private keys and passwords associated with your
              wallet are secure. Transactions with the Ethereum blockchain are
              publicly visible and we do not have the ability to undo or modify
              transactions.
            </p>
            <p>
            ...
            <p>
              ...
              access to any user, at any time in our sole discretion for any or
              no reason, including, if in our opinion you have failed to comply
            ...
            <p>
              ...
              proprietary rights laws. You agree to not copy, modify, create
              derivative works of, publicly display, publicly perform,
              republish, any of our copyrighted material, except to the extent
              permitted by the Website itself. If you have doubts about whether
              and how to use of material on the Website, please raise your
              concerns on our{" "}
            ...
            <p>
              ...
              provided, or otherwise made accessible on or through the Website.
            </p>
            <p>
              ...
              Service. Prohibited uses include violation of laws and
            ...
            <p>
              ...
              changes to the Services or the Site that you may choose in your
              sole discretion to provide us from time to time (“Feedback”). When
              you provide Feedback, you grant us, under all right, title and
              interest in and to the Feedback, a non-exclusive, royalty-free,
              worldwide, transferable, sub-licensable, irrevocable, perpetual
              license to use that Feedback or to incorporate it into the Website
              or other producs or services.
            </p>
            <p>
            ...
            <p>
              ...
              in the United States. We make no claims that the Website or any of
              its content is accessible, appropriate or legal outside of the
